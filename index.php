...
if (isset($_POST["signup"])) {
  ...
  $password = mysqli_real_escape_string($conn, hash('sha512',$_POST["signup_password"]));
  $cpassword = mysqli_real_escape_string($conn, hash('sha512',$_POST["signup_cpassword"]));
  $token = md5(rand());
  ...
  if ($password !== $cpassword) {
    ...
    if ($result) {
      ...
      <p>Thanks for registration! Verify your email to access website. Click below link to verify your email.</p>
